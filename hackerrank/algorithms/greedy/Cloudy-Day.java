...
class City {
  ...
  public void addCloud(Cloud cloud) {
    clouds.add(cloud);
    SortedMap<Long, Town> rainyTowns =
        towns.subMap(cloud.location - cloud.range, cloud.location + cloud.range + 1);
...
public class Solution {
  ...
  static long maximumPeople(long[] p, long[] x, long[] y, long[] r) {
    ...
    // Return the maximum number of people that will be in a sunny town after removing exactly one
    // cloud.
    // p = populations
    // x - location of town
