...
public class Solution {
  ...
  private static boolean[] sieve = sieveOfEratosthenes(1000);
  private static AL<Integer> primes = new AL<>();
  ...
  private static void solve() {
    ...
    for (int prime : primes) {
      ...
      if (divisors == 0) divisors += (counter + 1);
      else divisors *= counter + 1;
    }
    if (N == original) divisors = 2;
    else if (N != 1) divisors *= 2;
    writer.println(divisors);
  }
